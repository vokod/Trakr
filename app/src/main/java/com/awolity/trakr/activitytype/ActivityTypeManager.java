...
public class ActivityTypeManager {
    ...
    private ArrayList<ActivityType> createActivityTypes(Context context) {
        ...
        ActivityType walking = new ActivityType(context.getString(R.string.activity_type_walking), R.drawable.ic_walk_circle, R.drawable.ic_walk, walkingRecordParameters);
        ...
        ActivityType running = new ActivityType(context.getString(R.string.activity_type_running), R.drawable.ic_run_circle, R.drawable.ic_run, runningRecordParameters);
        ...
        ActivityType biking = new ActivityType(context.getString(R.string.activity_type_biking), R.drawable.ic_bike_circle, R.drawable.ic_bike, bikingRecordParameters);
        ...
        ActivityType driving = new ActivityType(context.getString(R.string.activity_type_driving), R.drawable.ic_car_circle, R.drawable.ic_car, drivingRecordParameters);
        ...
        ActivityType flying = new ActivityType(context.getString(R.string.activity_type_flying), R.drawable.ic_plane_circle, R.drawable.ic_plane, drivingRecordParameters);
